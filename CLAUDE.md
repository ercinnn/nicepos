...
- **Audit log** — rol-bazlı kısıtlama tamamlandı (bkz. "Çok Kiracılı Mimari" Faz B notu: Kasa/maliyet fiyatları/Satışı Sil artık staff'a kapalı), doğal bir sonraki adım "Satışı Sil" gibi kalıcı/geri alınamaz işlemler için kim-ne-zaman-ne-sildi kaydı tutan bir audit log tablosu — henüz yapılmadı.
