/// Ciro Analiz raporu satır modeli.
///
...
class CiroAnalizRecord {
  ...
  final num totalRevenue; // Gerçek ciro: satır indirimi + orantılı genel indirim düşülmüş toplam (bkz. ReportRepository.fetchCiroAnaliz)
  final num revenueSharePercent; // totalRevenue'nun aralıktaki TÜM ürünlerin toplam cirosuna oranı, 0-100

  // Ham `products.description` (Firma & GG/AA/YY & Durum). Ciro Analiz
  // Firma hücresi tıkla-düzenle akışı (ciro_analiz_tab.dart) tarih/durumu
