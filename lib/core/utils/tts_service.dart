...
/// Perde/hız/dil ayarlarını uygular. `setLanguage('en-GB')` ses seçiminden
/// BAĞIMSIZ kalır — dil ayarı tek başına motoru susturmaz, eşleşen bir ses
/// bulunamazsa motor kendi varsayılan sesine düşer (yanlış aksanla da olsa
/// SES ÇIKAR).
...
/// (`initState`) çağrılması önerilir (tıklama anında tekrar beklenmesin diye bir
/// optimizasyon) — `speakAmountInEnglish` zaten kendi içinde bu adımları
/// (tamamlanmadıysa) bekler.
...
/// çağrısına ulaşılmasını engelleyemez.
